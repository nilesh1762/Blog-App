...
import { followUserAction, userProfileAction , unfollowUserAction} from "../../../Redux/slice/users/userSlices";
...
const isLoginUser = userAuth?.data?.user?._id === profile?._id


  return (
    <>
    <div className= {profileAppErr || profileServerErr ? "min-h-screen bg-green-600 flex justify-center items-center" : ""}>
      {profileLoading ? <LoadingComponent /> : profileAppErr || profileServerErr ? <h2 className="text-yellow-400 text-2xl">  {profileServerErr} {profileAppErr}</h2>  :
            ...
            <article>
              ...
              <div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="hidden sm:block 2xl: mt-6 min-w-0 flex-1">
              ...
              <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                  ...
                  <ul className="">
                    ...
                    {profile?.viewedBy?.length <=0 ? <h1>No Viewer</h1> : 
                      profile?.viewedBy?.map((user, id) => (
                        <li key = {id}>
                ...
                <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                  ...
                  {/* Loo here */}
                  {profile?.post?.length <=0 ? <h2 className="text-center text-lg"> No Post Found </h2> : 
                  
                  profile?.post?.map((post) => (
                    <div className="flex flex-wrap  -mx-3 mt-3  lg:mb-6" key ={post?.id}>
