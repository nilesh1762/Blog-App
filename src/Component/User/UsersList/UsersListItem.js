...
import {  blockUserAction, UnblockUserDetailsAction } from "../../../Redux/slice/users/userSlices";
import { useDispatch, useSelector } from "react-redux";


const UsersListItem = ({user, getvalue}) => {
      ...
      <div className="p-8 mb-4 bg-white shadow rounded">
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0">
            ...
            {user?.isBlocked ? (
              <button
               onClick={() => dispatch(UnblockUserDetailsAction(user?._id))}
