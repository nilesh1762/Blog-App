...
import { fetchPostDetailaction, updatePostaction} from "../../Redux/slice/posts/postSlice";
...
const formSchema = Yup.object({
  ...
  export default function UpdatePost(props) {
    ...
    const { loading, appErr, serverErr, isUpdate } = postUpdate;
 console.log('Update post', postUpdate)
    //formik
